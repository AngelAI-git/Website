    ...
    <section className="section section--gradient" id="contact">
      <div className="container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <div className="contact-card glass-card reveal" style={{ width: '100%', position: 'relative', zIndex: 10 }}>
          <h2 className="feature__title reveal reveal--delay-1">We're Selectively Sharing Early Conversations</h2>
          ...
          <div className="contact-card__actions reveal reveal--delay-3" style={{ display: 'flex', justifyContent: 'center' }}>
          ...
          <div className="contact-card__note reveal reveal--delay-4">
